...
public void handle(MouseEvent event)
{
	...
	circ1.setVisible(false);
	 ...
	 { 
         ...
         shapeList.add(rec1);
		 }							//the x and y coordinates of users mouse is retrieved on mousepressed and the rectangle or circle is added to the canvas and shapeList  
		 else
		 {
...
public void handle(ActionEvent event)
{
	...
	if(colorselection == "Blue")
		color = Color.BLUE;
	if(colorselection == "Green")				//sets the Color variable to the selected color of the combobox
		color = Color.GREEN;
