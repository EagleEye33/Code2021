...
public class LinkedStack<Item> implements Iterable<Item> {
    ...
    public void push(Item item) {
        ...
        first.item = item;
        first.next = oldfirst;
        System.out.println("first " + first + "first.next " + first.next);
        n++;
        assert check();
    }
    ...
    public Item pop() {
        ...
        System.out.println(first + "" + item);// save item to return
        first = first.next;
        System.out.println(first + "" + first.item);// delete first node
        n--;
        assert check();
